	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (!listCart.isEmpty()) {
			if (acount != null) {
				...
				new_bill = new Bill(idOfCompute, user, phone, tongtien, listCart.size(), address, note);
				check = false;
			}
			...
			for (Card card : listCart) {
				...
				if (ctbill.insert_CT_Bill(ct_Bill)) {
					thongbao = "Chốt đơn thành công";
				} else {
					thongbao = "Chốt đơn thất bại";
				}
			}
